    ...
    <div className="bg-[#f7f2e8] relative min-h-screen">
      ...
      <div className="block md:hidden">
        ...
        <main className="pt-24 px-6 pb-32">
          <h1 className="font-['Artifex_Hand_CF',_sans-serif] text-[28px] leading-[40px] text-[#1a2e66] mb-8">Datenschutzerklärung</h1>
          
          <div className="font-['Maison_Neue_Mono',_sans-serif] text-[#1a2e66]">
            <h2 className="font-['Artifex_Hand_CF',_sans-serif] text-[18px] leading-[25px] mb-2">1. Datenschutz auf einen Blick</h2>
            ...
            <h2 className="font-['Artifex_Hand_CF',_sans-serif] text-[18px] leading-[25px] mb-2">2. Verantwortliche Stelle</h2>
            ...
            <h2 className="font-['Artifex_Hand_CF',_sans-serif] text-[18px] leading-[25px] mb-2">3. Erhebung und Speicherung personenbezogener Daten</h2>
            <p className="text-[12px] leading-[20px] mb-2">a) Beim Besuch der Website</p>
            <p className="text-[12px] leading-[20px] mb-4">
            ...
            <ul className="list-disc ml-6 text-[12px] leading-[20px] mb-4">
            ...
            <p className="text-[12px] leading-[20px] mb-2">b) Bei Nutzung des Kontaktformulars / E-Mail</p>
            <p className="text-[12px] leading-[20px] mb-6">
            ...
            <h2 className="font-['Artifex_Hand_CF',_sans-serif] text-[18px] leading-[25px] mb-2">4. Cookies</h2>
            <p className="text-[12px] leading-[20px] mb-6">
            ...
            <h2 className="font-['Artifex_Hand_CF',_sans-serif] text-[18px] leading-[25px] mb-2">5. Analyse-Tools und Tools von Drittanbietern</h2>
            <p className="text-[12px] leading-[20px] mb-2">Sofern Analyse-Tools wie Google Analytics oder andere Dienste eingesetzt werden, informieren wir Sie darüber:</p>
            <p className="text-[12px] leading-[20px] mb-2 font-bold">Google Analytics</p>
            <p className="text-[12px] leading-[20px] mb-4">
            ...
            <h2 className="font-['Artifex_Hand_CF',_sans-serif] text-[18px] leading-[25px] mb-2">6. Weitergabe von Daten</h2>
            <p className="text-[12px] leading-[20px] mb-6">
            ...
            <h2 className="font-['Artifex_Hand_CF',_sans-serif] text-[18px] leading-[25px] mb-2">7. Ihre Rechte</h2>
            <p className="text-[12px] leading-[20px] mb-4">Sie haben das Recht:</p>
            <ul className="list-disc ml-6 text-[12px] leading-[20px] mb-4">
            ...
            <h2 className="font-['Artifex_Hand_CF',_sans-serif] text-[18px] leading-[25px] mb-2">8. Datensicherheit</h2>
            <p className="text-[12px] leading-[20px] mb-6">
            ...
            <h2 className="font-['Artifex_Hand_CF',_sans-serif] text-[18px] leading-[25px] mb-2">9. Aktualität und Änderung dieser Datenschutzerklärung</h2>
            <p className="text-[12px] leading-[20px] mb-6">
