...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-6 right-6 w-[400px] bg-[#f5f5f5] rounded-lg shadow-lg z-50 p-6">
      {/* Descriptive Text */}
      <p className="font-['Maison_Neue_Mono',_sans-serif] text-[14px] text-[#333] leading-[20px] mb-6">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        {[
          ...
          <div key={key} className="flex items-center justify-between">
            <span className="font-['Maison_Neue_Mono',_sans-serif] text-[14px] text-[#333]">
              {label}
            </span>
            <button
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between">
          <button
            ...
            className="bg-gray-400 text-[#333] px-4 py-2 rounded font-['Maison_Neue_Mono',_sans-serif] text-[14px] hover:opacity-80 transition-opacity"
          >
            Reject all
          </button>
          <button
            onClick={handleAcceptAll}
            className="bg-white text-[#333] px-4 py-2 rounded font-['Maison_Neue_Mono',_sans-serif] text-[14px] hover:opacity-80 transition-opacity"
          >
            Accept all
          </button>
        </div>
        ...
        <Link
          ...
          className="block w-full bg-[#1a2e66] text-white px-4 py-2 rounded text-center font-['Maison_Neue_Mono',_sans-serif] text-[14px] hover:opacity-80 transition-opacity"
        >
          Learn more
        </Link>
      </div>
