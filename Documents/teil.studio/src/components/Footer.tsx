  ...
  if (variant === 'flow') {
    return (
      <div className="w-full bg-[#1a2e66]" data-name="Footer" data-node-id="91:61">
        ...
        <div className="hidden md:block w-full px-6 md:px-0 flex flex-col justify-between pt-12 pb-12">
          {/* Top Section */}
        ...
        <div className="block md:hidden px-6 py-10 space-y-6">
          ...
          <div className="space-y-2">
            <p className="font-['Maison_Neue_Mono',_sans-serif] text-[8px] text-white -mt-3">More teil.studio</p>
            <a
              href="https://www.linkedin.com/in/koljaorzeszko"
              target="_blank"
              rel="noopener noreferrer"
              className="block font-['Maison_Neue_Mono',_sans-serif] text-[12px] text-white hover:opacity-80 my-4"
            >
              LinkedIn
            </a>
          </div>
          ...
          <div className="space-y-3">
            <p className="font-['Maison_Neue_Mono',_sans-serif] text-[8px] text-white -mt-3">Want more teil.studio</p>
            <p className="font-['Maison_Neue_Mono',_sans-serif] text-[12px] text-white mt-6">Get our emails. Updates.</p>
            <form onSubmit={handleNewsletterSignup} className="flex">
              {/* Honeypot field - hidden from humans, visible to bots */}
              <input
                type="text"
              ...
              <div className="relative flex-1">
                <input
                  ...
                  placeholder=""
                  required
                  className="border border-white bg-transparent h-[57px] w-full px-4 pt-6 text-white placeholder-white font-['Maison_Neue_Mono',_sans-serif] text-[12px] outline-none"
                />
                <label className="absolute left-4 top-1 font-['Maison_Neue_Mono',_sans-serif] text-[12px] text-white">Email</label>
              </div>
              <button type="submit" disabled={isSubmitting} className="bg-white h-[57px] w-[103px] disabled:opacity-50 flex items-center justify-center">
          ...
          <div className="flex items-center space-x-4">
            <div className="h-[28px] w-[75px]">
              <Link href="/" className="block w-full h-full hover:opacity-70 transition-opacity">
                <Image alt="teil.studio logo" src="/logos/Element 7 3.svg" width={75} height={28} className="block max-w-none size-full" />
              </Link>
            </div>
            <span className="font-['Maison_Neue_Mono',_sans-serif] text-[12px] text-white mt-6">©2025</span>
          </div>
        </div>
      </div>
    );
